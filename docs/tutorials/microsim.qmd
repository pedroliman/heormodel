...
check = MicrosimModel.discrete(
    states=STATES,
    transition_probabilities=lambda params, strategy, state, attrs, rng: P[state],
    state_rewards=lambda params, strategy, state, attrs: (cost_vec[state], eff_vec[state]),
    population=60_000, strategies=["cohort"], n_cycles=40,
)
