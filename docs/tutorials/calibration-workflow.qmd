...
print(record.to_markdown("heval calibration workflow run report"))
```

Next: the [microsimulation](microsim.qmd) and [discrete-event](des.qmd) engines replace this hand-written model while keeping the same analysis layer.
