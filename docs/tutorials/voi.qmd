...
The ranking is threshold-specific: below about 28,000 per QALY the cost leads instead. The default `spline` metamodel suits one or two parameters; `method="gp"` (a Gaussian process) scales to many-parameter groups.
