...
With a memoryless, homogeneous population, the microsimulation mean should approach the cohort trace as the population grows; if it did not, one of the two implementations would have a bug. The check below runs the microsimulation at increasing population sizes and compares each to the cohort trace computed above.
