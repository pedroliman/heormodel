...
from heval.voi._metamodel import fitted_conditional_means, voi_from_fitted
...
def simulate_summaries(
    ...
    *,
    ...
    Example:
        ...
        >>> from heval.voi import simulate_summaries
...
def evsi_regression(
    ...
    *,
    ...
    Example:
        ...
        >>> from heval.voi import evsi_regression
